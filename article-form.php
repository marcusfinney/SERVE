		            ...
		            <div class="row">
		                <div class="span8 wrapper post">
		                    ...
		                    <div class="padding30">
		                        ...
		                        <h2 class="post-title">Serving Veterans and Military Families</h2>
		                        <div class="author">
		                            <p>posted by:
		                                <a>John Doe</a>
		                                in 
...
<NYT_UPDATE_BOTTOM>
		                ...
		                <div class="comment-container span8">
		                    <h3 class="serif italic">Comments, Notes and Discussion on <i><b>Quantum Computing</b></i>:</h3>
		                    <div class="comments">
		                        <ul class="media-list">
		                            <li class="media">
		                                        ...
		                                        <div class="comment-body">
		                                            <p>
		                                                Integer factorization is believed to be computationally infeasible with an ordinary computer for large integers if they are the product of few prime numbers (e.g., products of two 300-digit primes).
		                                                 By comparison, a quantum computer could efficiently solve this problem using Shor's algorithm to find its factors. This ability would allow a quantum 
